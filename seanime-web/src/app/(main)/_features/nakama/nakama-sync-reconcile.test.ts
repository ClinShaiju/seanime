// Run: cd seanime-web && npx tsx "src/app/(main)/_features/nakama/nakama-sync-reconcile.test.ts"
// No test framework in this project — a plain assert self-check (ponytail: one runnable check).
...
console.log("nakama-sync-reconcile: all assertions passed")
